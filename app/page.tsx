...
export default function Home() {
  ...
  const features = [
    ...
    { icon: <Gamepad2 className="h-8 w-8" />, title: "Game Development", description: "Engaging games designed for entertainment and user engagement" }
  ];

  const stats = [
    { number: 50, label: "Projects Completed", icon: <Target className="h-6 w-6" />, suffix: "+" },
    { number: 30, label: "Happy Clients", icon: <Users className="h-6 w-6" />, suffix: "+" },
      ...
      <section className="py-20 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400">Don't just take our word for it - see what our clients say</p>
          </div>
